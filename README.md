☕ Restritto Café Bar
Projeto desenvolvido na disciplina de Projeto Integrador no curso de Tecnologia em Sistemas para internet pelo Instituto Federal de Brasília- Campus Brasília, com foco na criação de um website institucional para a empresa Restritto Café Bar.
...
Repositório Principal: https://github.com/infocbra/2025-2-vespertino-pi1-g2-2025-2
...
Protótipo no Figma: https://www.figma.com/design/pSGrqrZ4uSJNWiQBkG6ju4/wireframes?node-id=0-1&p=f&t=e4AQkUVI4rmqfAux-0

📋 Descrição da Sprint
Sprint Atual
Atualização da documentação do projeto; *Back-end; *Diagrama de classes; *Imntegração do Back-end; *Implementação do Front-end e Back-end; *implementação de acessibilidade ALT;
...
| Gustavo A. | Desenvolvedor/ Documentação/ Github |
...
📢 Compartilhe o projeto com outras pessoas! 🍺 Convide a equipe para um café ou uma cerveja! 🫂 Obrigado pelo apoio e colaboração.
